...
import { List, Datagrid, TextField, EditButton, TextInput, Edit, SimpleForm, Create,LongTextInput,SelectInput } from 'react-admin';
...
export const FestivalCreate = props => (
	<Create {...props}>
      ...
      <SelectInput source="location.country" label="Country" choices={countries} optionText="label" optionValue="value"/>
